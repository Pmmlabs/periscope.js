...
function getDescription(stream) {
    ...
    var description = $('<div class="description">\
        ...
        .append(deleteLink, '<br/>', screenlistLink, userLink, (stream.share_display_names ? ', shared by ' + stream.share_display_names[0] : ''), (stream.channel_name ? ', on channel ' + stream.channel_name : ''), '<br/>', chatLink, '<br/>', ('<span class="lang right" title="Language ' + stream.language + '">' + getFlag(stream.language) + '</span>'),
